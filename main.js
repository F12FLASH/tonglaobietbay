...
var loadImages = function(){
	...
	bird = new Image();
	bird.src = 'images/tonglao.png';
	bird.onload = onImgLoad;
	
	pipe = new Image();
	pipe.src = 'images/cotpvc0.png';
	pipe.onload = onImgLoad;
	
	pipeUp = new Image();
	pipeUp.src = 'images/cotpvc1.png';
	pipeUp.onload = onImgLoad;
	
	pipeDown = new Image();
	pipeDown.src = 'images/cotpvc.png';
